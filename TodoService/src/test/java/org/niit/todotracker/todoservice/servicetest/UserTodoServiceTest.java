...
public class UserTodoServiceTest {
    ...
    public void setUp()
    {
        ...
        user=new User("Drake","xyz","10101010",
                "abc@gmail.com","abc@951", setCat, setTodo);
    ...
    {
        User u1=new User("Flake","xyz","10101010",
                "flake@gmail.com","abc@951", setCat, setTodo);
    ...
    public void addCategoryOfUserSuccess()
    {
        ...
        assertEquals(user,todoService.addUsersCategoryToSet(category1, user.getEmail()));                              // addUsersCategoryToList
    }
    ...
    public void addCategoryOfUserFailure()
    {
        ...
        assertThrows(ResourceNotFoundException.class,()->todoService.addUsersCategoryToSet(category1,user.getEmail()));
    }
    ...
    public void addTodoSuccessfully()
    {
        ...
        when(iUserRepository.findById(user.getEmail())).thenReturn(Optional.ofNullable(user));
        when(iUserRepository.save(user)).thenReturn(user);
        assertEquals(user,todoService.addUsersTodoToSet(todo1,user.getEmail()));
    ...
    public void addTodoFailure()
    {
        Todo todo1=new Todo("123","abc","abc123","high",now,now,null);
        when(iUserRepository.findById(user.getEmail())).thenReturn(Optional.ofNullable(null));
        assertThrows(ResourceNotFoundException.class,()->todoService.addUsersTodoToSet(todo1,user.getEmail()));
    }
    @Test
