package org.niit.todotracker.todoservice.repositorytest;
...
@DataMongoTest
public class UserTodoRepositoryTest {
    private User user;
    private User user1;
...
//        category=new Category("101","My Category", setTodo);
        ...
        user=new User("Drake","xyz","10101010","abc@gmail.com","abc@951", setCat, setTodo);
        user1=new User("Drake","xyz","10101010","abc@gmail.com","abc@951", setCat, setTodo);
    }
